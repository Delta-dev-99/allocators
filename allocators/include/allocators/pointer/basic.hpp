...
namespace dd99::memory::pointer_allocator
{
    ...
    public:
        ...
        void *allocate(std::size_t requested_size)
        {
            ...
            return reinterpret_cast<void *>(reinterpret_cast<std::uintptr_t>(allocated_block.base) + sizeof(Block));
        }
        ...
        void deallocate(void *memory)
        {
            if (owns(memory))
            {
                ...
                auto &allocated_block = *reinterpret_cast<Block *>(reinterpret_cast<std::uintptr_t>(memory) - sizeof(Block));
        ...
        { return m_sub_alloc.owns(reinterpret_cast<void *>(reinterpret_cast<std::uintptr_t>(memory) - sizeof(Block))); }
