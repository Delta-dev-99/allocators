...
// // Allocator type
// using BuddyAlloc = dd99_allocators_namespace::block_allocator::Buddy<BLOCK_SIZE, LEVELS>;

// // Simple linear allocator for tracking allocated blocks in test
// struct AllocRecord {
//     dd99_allocators_namespace::block block;
//     bool used = false;
// };
...
// // ------------------------------------------------------------------
// bool block_within(dd99_allocators_namespace::block b, std::byte* mem, std::size_t size) {
...
//     BuddyAlloc buddy(dd99_allocators_namespace::block{mem, MEM_SIZE});
...
//     auto store_alloc = [&](dd99_allocators_namespace::block blk) {
//         if (!blk) return;
...
//         for (int i = 0; i < 4; ++i) {
//             dd99_allocators_namespace::block blk = buddy.allocate(sz);
//             if (blk) {
...
//     dd99_allocators_namespace::block blk;
...
//     for (std::size_t i = 0; i < alloc_count / 2; ++i) {
//         dd99_allocators_namespace::block blk2 = buddy.allocate(64);
//         if (!blk2) break;
//         store_alloc(blk2);
//         ++reallocated;
//     }
...
//     BuddyAlloc buddy2(dd99_allocators_namespace::block{mem, MEM_SIZE});
